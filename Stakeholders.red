...
<file:File xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:document="dk.dtu.imm.red.core.element.document" xmlns:file="dk.dtu.imm.red.core.file" xmlns:text="dk.dtu.imm.red.core.text" label="" name="Stakeholders.red" elementKind="unspecified" description="Contains details about the stakeholders of our project" timeCreated="2015-09-22T10:24:31.274+0200" lastModified="2015-09-25T14:45:00.368+0200" uniqueID="3b50cf6d-3145-4e7c-b2e3-9098d65466a9" workPackage="">
  ...
  <cost name="Cost" kind=""/>
  <benefit name="Cost" kind=""/>
  <contents xsi:type="document:Document" label="Label" name="Goals" elementKind="" description="This document sums up all the goals, in the various stages/levels." timeCreated="2015-09-22T10:58:39.953+0200" lastModified="2015-09-25T14:45:00.365+0200" uniqueID="0d7f80f0-a35c-4b16-b2ab-262356c23986" workPackage="" externalFileRef="">
    ...
    <textContent>
      <fragments xsi:type="text:FormattedText" text="&lt;P>&lt;FONT size=6>Goals:&lt;/FONT>&lt;/P>&lt;BR>&lt;BR>&lt;IMG src=&quot;http://i.imgur.com/IfkFH2h.png&quot;>&amp;nbsp; &#xD;&#xA;&lt;P>&lt;BR>In the perspective of the European Union (Harald St&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;&#xf6;rle):&lt;/P>&#xD;&#xA;&lt;P>______________________________________________________________________________________&lt;BR>ENTIRE EU HEALTHCARE PROJECT&lt;BR>^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^&lt;BR>&lt;BR>Stake (personal or institutional objectives):&lt;BR>Stake 1: To expand and reinforce the ideal of a united European Union, with&amp;nbsp;international collaboration.&lt;/P>&#xD;&#xA;&lt;P>Stake 2: &lt;BR>&amp;nbsp;&lt;/P>&#xD;&#xA;&lt;P>Strategic Goal:&lt;BR>To expand the EU collaboration with an international healthcare system.&lt;BR>&lt;/P>&#xD;&#xA;&lt;P>Business Goal:&lt;BR>Improve health care systems for each member state&lt;BR>______________________________________________________________________________________&lt;BR>CASE SPECIFIC PROJECT&lt;BR>^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^&lt;BR>&lt;/P>&#xD;&#xA;&lt;P>Solution Goal:&lt;BR>Provide better and faster access to patient data during critical hospital processes for international citizens in the EU&lt;BR>&lt;BR>Solution Behavior:&lt;BR>Direct access from existing technological devices to European Medical Database, in order to&amp;nbsp;apply the correct treatment for&amp;nbsp;all EU citizens.&amp;nbsp;&lt;BR>&lt;/P>&#xD;&#xA;&lt;P>Thoughts:&lt;/P>&#xD;&#xA;&lt;P>- To ensure safety of the European &lt;/P>&#xD;&#xA;&lt;P>- PURRfect treatment of patients&lt;/P>&#xD;&#xA;&lt;P>- Doctors dont know who the fuck u are and then they have no idea what treatments to give you lmao.&lt;/P>"/>
    </textContent>
    <captionedImageList/>
  </contents>
  <longDescription>
